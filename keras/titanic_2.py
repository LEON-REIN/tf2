...
dftest_raw = pd.read_csv(r'datasets\titanic\test.csv')
test_answer_raw = pd.read_csv(r'datasets\titanic\gender_submission.csv')
...
model_loaded = models.load_model(r'datasets\titanic\tf_model_savedmodel')
